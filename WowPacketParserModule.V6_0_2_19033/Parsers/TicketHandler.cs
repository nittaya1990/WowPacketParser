...
namespace WowPacketParserModule.V6_0_2_19033.Parsers
{
    public static class TicketHandler
    {
        ...
        public static void ReadCliSupportTicketLFGListSearchResult(Packet packet, params object[] idx)
        {
            ...
            packet.ReadWoWString_Sanitize("Title", length88, idx);
            packet.ReadWoWString_Sanitize("Description", length217, idx);
            packet.ReadWoWString_Sanitize("VoiceChat", length1242, idx);
        }
